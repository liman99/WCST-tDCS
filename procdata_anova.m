...
% #8: type_rule [1,2], 1: color; 2: arrow                           # separate
% #9: type_shiftprep [1,2], 1: rule stable period; 2: rule unstable period (with cue)   # separate
...
% #8: RRadjPrevI
% #9: RRadjCSE
% #10: type_rule [1,2], 1: color; 2: arrow                           # separate
% #11: type_shiftprep [1,2], 1: rule stable period; 2: rule unstable period (with cue)  # separate
