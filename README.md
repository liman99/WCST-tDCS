...
| 8  | type\_shiftprep      | rule-switch preparatory phase: 1 = rule stable phase, 2 = switch preparatory phase (with cue), 3 = linking trial         |
...
| 9  | **type\_shiftprep**     | rule-switch preparatory phase:  <br> 1 = rule stable phase  <br> 2 = switch preparatory phase (with cue)                                                                                                                                                                                                                                                            |
...
| 11 | type\_shiftprep      | Rule-switch preparatory phase: 1 = rule stable phase, 2 = switch preparatory phase               |
